...
export const uiCopy = {
  zh: {
    ...
    resetView: '重置视角',
    modelUnavailable: '这个 3D 模型暂时无法加载',
    seeReferenceImages: '查看参考图片',
  ...
  en: {
    ...
    resetView: 'Reset',
    modelUnavailable: 'This 3D model could not be loaded',
    seeReferenceImages: 'See reference images',
    openSpotify: 'Open Spotify',
    openNavigator: 'Open navigation',
    closeNavigator: 'Close navigation',
